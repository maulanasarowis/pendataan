    ...
    <div class="row text-center ">
      <div class="col-md-12">
        <li class="text-center">
          <img src="assets/img/psbr.png" class="user-image img-responsive" />
          <h4>Sistem Informasi Pendataan Penerima Manfaat</h4>
          <h4>Panti Sosial Bina Remaja "Rumbai" Pekanbaru - PSBR</h4>
        </li>
        <br />
      </div>
    </div>
...
if (isset($_POST['login'])) {
  ...
  $sql = $koneksi->query("SELECT * FROM tb_admin WHERE username ='$username' AND password ='$pass'");
